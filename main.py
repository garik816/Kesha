...
hiPhrase7 = "Вуаля! Стоило только запустить Кешу — и вот уже кэш Вашего Плагиатуса почищен!"
...
nonePhrase4 = "В салоне тихо, чисто и пусто. Только в одном из углов вышивает гладью пожилая княжна.\nНо её чистить не надобно. Посему соблаговолите закрыть Иннокентия и приступить к работе."
nonePhrase5 = "ЗНАЕТЕ ЛИ ВЫ, ЧТО\nбоязнь грязи называется рипофобия и относится к психическим расстройствам?\nТак что, дабы не прослыть психом, закрывайте скорее Кешу и приступайте к работе, ибо кэш Вашего Плагиатуса ещё безупречно чист."
nonePhrase6 = "Вы ещё даже не поработали в Плагиатусе, а уже кэш ему чистить собрались!\nИ не стыдно Вам?\nА ну-ка быстро закрывайте Кешу и приступайте к работе!"
nonePhrase7 = "Ну и зачем Вы открыли Кешу? Кеша хороший. Его не надо дёргать по пустякам.\nНапример, когда кэш Вашего Плагиатуса ещё девственно чист, то есть сейчас.\nВ общем, закрывайте Иннокентия и беритесь за дело, наконец.."
...
nonePhrase9 = "Между прочим, Кеша — ясновидящий. И сейчас он видит то, что кэш твоего Плагиатуса идеально чист, будто программу и не запускали ещё.\nСкорее пользуйся этой чистотой и проверяй тексты!"
...
nonePhrase12 = "Засяльника, зачем Кешу запускаиш мана? Тут и так чиста мана. Спирва текст напиши да, патом в Плагиатусе прагани да, а патом Кешу запускай да. Сийчас Кешу закрывай да."
